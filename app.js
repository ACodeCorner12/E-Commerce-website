...
//use query selector to choose and dyanmaically change the product details when clicked upon in the nav bar
...
//change color when clicked upon in the color choices section of webpage
currentProductColor.forEach((color,index)=>{
